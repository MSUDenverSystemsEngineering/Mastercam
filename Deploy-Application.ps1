...
Try {
	...
	[string]$appScriptDate = '09/17/2020'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Execute-Process -Path "$dirFiles\mastercam2021-web.exe" -Parameters "-sp /silent /action=install /language=en-US"
		...
		Remove-File -Path "C:\Users\Public\Desktop\Mastercam 2021.lnk"

		[scriptblock]$HKCURegistrySettings = {
			Set-RegistryKey -Key "HKEY_CURRENT_USER\Software\CNC Software, Inc.\Mastercam 2021\Configurations\Dialog data\UpdateNotify" -Name "AutoCheck" -Value "0" -Type "DWord" -SID $UserProfile.SID
			Set-RegistryKey -Key "HKEY_CURRENT_USER\Software\CNC Software, Inc.\Mastercam 2021\Customer Feedback Program" -Name "Enabled" -Value "0" -Type "DWord" -SID $UserProfile.SID
			Set-RegistryKey -Key "HKEY_CURRENT_USER\Software\CNC Software, Inc.\Mastercam 2021\Customer Feedback Program" -Name "Reminder" -Value "7:17:2020:18:12:38" -Type "String" -SID $UserProfile.SID
			Set-RegistryKey -Key "HKEY_CURRENT_USER\Software\CNC Software, Inc.\Mastercam 2021" -Name "EULA count" -Value "2" -Type "DWord" -SID $UserProfile.SID
		}
